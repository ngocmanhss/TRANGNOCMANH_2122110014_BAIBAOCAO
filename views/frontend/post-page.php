...
<body>
            ...
            <div class="col-12 col-sm-12 d-none d-md-block col-md-4 text-center py-2">
               <div class="call-login--register border-bottom">
                  <ul class="nav nav-fills py-0 my-0">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="profile.html">TRẦN NGỌC MẠNH</a>
                     </li>
                  </ul>
               </div>
               <div class="fs-6 py-2">
   ...
   <section class="nm-mainmenu bg-main">
      <div class="container">
         <div class="row">
            <div class="col-12 col-md-12">
               <nav class="navbar navbar-expand-lg bg-main">
                  <div class="container-fluid">
                     <a class="navbar-brand d-block d-sm-none text-white" href="index.html">NgocManhSHOP</a>
   ...
   <section class="nm-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               <h3 class="widgettilte">CHÚNG TÔI LÀ AI ?</h3>
               <p class="pt-1">
                  Copyright@ 2024 NgocManhShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  Địa chỉ: 123/1 Hoàng Diệu 2, Linh Trung, Thủ Đức
               </p>
               <p class="pt-1">
                  Điện thoại: 0909090909(call, zalo) - Email: ngocmanhu97@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: TRẦN NGỌC MẠNH - Phone: 090909090909
      </div>
   </section>
</body>
